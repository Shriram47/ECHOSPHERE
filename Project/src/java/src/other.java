 ...
 public static String trimTo100Words(String originalString) {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet other at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try{   for(Cookie irs:crs)
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("select * from post where sub_genre is not null order by RAND()");
