...
import static src.other.trimTo100Words;
import static src.story.trimTo100Words;

/**
 *
 * @author HP
 */
public class fiction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet fiction</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet fiction at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("select * from post where genre='fiction' order by RAND()");
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>FICTION EXPLORE</title>");
                out.println("</head>");
                out.println("<body>");
            ...
            <h2>AKA: <%= first_name+" "+last_name%></h2><br><hr>*/
                ...
                out.println("<h1>FICTION BLOGS</h1><hr>");
     ...
     //   out.println("<button onclick=\"navigateToPage('intermediater')\">EXPLORER </button>");
        ...
        out.println("<button onclick=\"navigateToPage('story')\">Story</button>");
