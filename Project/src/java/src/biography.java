...
import static src.fiction.trimTo100Words;
 ...
 public static String trimTo100Words(String originalString) {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet biography</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet biography at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      int count=0;
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("select * from post where genre='biography' order by RAND()");
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<h1>BIOGRAPHY BLOGS</h1><hr>");
